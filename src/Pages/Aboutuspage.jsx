      ...
      <div className="flex flex-col  dark:text-gray-200">
        ...
        <div className="flex flex-col gap-y-5 justify-between">
          <div className="p-5  dark:bg-gray-700 bg-slate-300 shadow-md rounded-xl">
            <h1 className="md:text-3xl dark:text-black mb-2 text-xl font-semibold uppercase bg-gradient-to-r from-gray-400 p-2 via-transparent to-transparent">
              Introduction
            </h1>
            <h2 className="lg:text-2xl md:text-xl  text-justify md:tracking-normal tracking-tighter">
          ...
          <div className="p-5  dark:bg-gray-700 bg-slate-300 shadow-md rounded-xl">
            <h1 className="md:text-3xl dark:text-black text-xl mb-2 uppercase font-semibold bg-gradient-to-r from-gray-400 p-2 via-transparent to-transparent">
              Mission
            </h1>
            <h2 className="lg:text-2xl md:text-xl text-justify md:tracking-normal tracking-tighter ">
