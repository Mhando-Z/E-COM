    ...
    <div className="sticky top-0 ">
      <div className="bg-gray-300 relative md:p-2  md:mb-16 mb-3 shadow-xl py-2 mt-2 flex container mx-auto items-center justify-between">
        ...
        <div className="md:flex hidden  items-center gap-x-10 justify-between">
          <Link
            className="text-xl hover:font-semibold hover:text-pink-600 xl:text-2xl focus:underline duration-1000 focus:scale-y-110 focus:underline-offset-8 decoration-pink-600"
            to={"/"}
          >
            Home
          </Link>
